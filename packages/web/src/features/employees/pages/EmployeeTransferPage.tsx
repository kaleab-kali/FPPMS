...
export const EmployeeTransferPage = React.memo(() => {
	...
	const handleCreateTransfer = React.useCallback(() => {
		if (!selectedEmployee || !transferForm.toCenterId || !transferForm.effectiveDate || !transferForm.transferReason) {
				...
				<DialogContent className="sm:max-w-lg max-h-[90vh] overflow-y-auto">
					...
					<div className="space-y-4">
						...
						<div className="space-y-2">
							...
							<Select value={transferForm.toCenterId} onValueChange={(v) => handleTransferFormChange("toCenterId", v)}>
								<SelectTrigger>
